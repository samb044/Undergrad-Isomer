...
# -----------------------------
# 1. Load image - Change this to your file path
# -----------------------------
img = Image.open(
    '/Users/trumanparrish/Downloads/Sample Generated YY Matrix (24).png'
).convert("L")
